...
// NOTE order matters! Must come before routes that display the model
router.get('/healthPractice/create', healthPracticeController.healthPractice_create_get);

// POST request for creating a healthPractice
router.post('/healthPractice/create', healthPracticeController.healthPractice_create_post);

// GET req for deleting a healthPractice
router.get('/healthPractice/:id/delete', healthPracticeController.healthPractice_delete_get);

// POST req for deleting a healthPractice
router.post('/healthPractice/:id/delete', healthPracticeController.healthPractice_delete_post);

// GET req for updating a healthPractice
router.get('/healthPractice/:id/update', healthPracticeController.healthPractice_update_get);

// POST req for updating a healthPractice
router.post('/healthPractice/:id/update', healthPracticeController.healthPractice_update_post);

// GET req for displaying a single healthPractice
router.get('/healthPractice/:id', healthPracticeController.healthPractice_detail);
...
router.get('/precaution/:id/delete', precautionController.precaution_delete_get);

// POST req for deleting a precaution
router.post('/precaution/:id/delete', precautionController.precaution_delete_post);

// GET req for updating a precaution
router.get('/precaution/:id/update', precautionController.precaution_update_get);

// POST req for updating a precaution
router.post('/precaution/:id/update', precautionController.precaution_update_post);
...
router.get('/profession/:id/delete', professionController.profession_delete_get);

// POST req for deleting a profession
router.post('/profession/:id/delete', professionController.profession_delete_post);

// GET req for updating a profession
router.get('/profession/:id/update', professionController.profession_update_get);

// POST req for updating a profession
router.post('/profession/:id/update', professionController.profession_update_post);
